        ...
        <div className='container pb-5'>
            ...
            <div className='row'>
                ...
                <div className='col-md-5'>
                    ...
                    <div className='pt-2'>
                        <input type="radio" onClick={handlePaymentMethod} checked={paymentMethod == 'e-sewa'} value={'e-sewa'} />
                        <label htmlFor="" className='form-label ps-2'>E-sewa</label>

                        <input type="radio" onClick={handlePaymentMethod} checked={paymentMethod == 'khalti'} value={'khalti'} className='ms-3' />
                        <label htmlFor="" className='form-label ps-2'>Khalti</label>
                    </div>
